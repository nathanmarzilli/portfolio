...
END:VCALENDAR`;
			...
			// ==============================================
            // 4. IMPROVEMENTS "ROLLS ROYCE" (UI/UX)
            // ==============================================
            
            // A. Animation d'apparition au scroll (Scroll Reveal)
            // --------------------------------------------------
            ...
            // B. Gestion du bouton "Back to Top"
            // --------------------------------------------------
            ...
            // C. Système de Toast Notifications (Global)
            // --------------------------------------------------
            ...
            // D. Fermeture auto du menu mobile au clic sur un lien
            // --------------------------------------------------
            ...
            mobileLinks.forEach(link => {
                link.addEventListener('click', () => {
                    if (mobileMenu && !mobileMenu.classList.contains('translate-x-full')) {
                        ...
                        // Reset icône menu si nécessaire
